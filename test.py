...
mask4key = np.load(open('/home/huy/Home/KGSF_new/mask4key.npy','rb'))
mask4movie = np.load(open('/home/huy/Home/KGSF_new/mask4movie.npy','rb'))

print(mask4key.shape)

print(mask4movie.shape)

print(mask4key[:100])

print(mask4movie[:100])

print(np.sum(mask4movie))