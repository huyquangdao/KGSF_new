...
class CrossModel(nn.Module):
    def __init__(
        ...
        self.user_norm_1 = nn.Linear(opt["dim"] * 2, opt["dim"])
        self.gate_norm_1 = nn.Linear(opt["dim"], 1)
        
        self.user_norm_2 = nn.Linear(opt["dim"] * 3, opt["dim"])
        self.gate_norm_2 = nn.Linear(opt["dim"], 1)
...
#         print(len(self.word_item_edge_sets))
        ...
        self.dbpedia_RGCN_2 = RGCNConv(
            64, 64, self.n_relation, num_bases=opt["num_bases"]
        )
