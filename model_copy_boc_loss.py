...
#         )
    ...
    def forward(
        ...
        for i, seed_set in enumerate(seed_sets):
            ...
            proj_user_representation = entities_features[seed_set]  # torch can reflect
        ...
        graph_con_emb = word_features[concept_mask]
        ...
        entity_scores = F.linear(user_emb, entities_features , self.output_en.bias)
        ...
        # generation---------------------------------------------------------------------------------------------------
        con_nodes_features4gen = word_features  # self.concept_GCN4gen(con_nodes_features,self.concept_edge_sets)
        ...
        db_emb4gen = entities_features[entity_vector]  # batch*50*dim
        ...
        movie_mask = torch.sum(db_label, dim =-1)
    ...
    def save_model(self):
        torch.save(self.state_dict(), "saved_model/boc_net_parameter1.pkl")

    def load_model(self):
        self.load_state_dict(torch.load("saved_model/boc_net_parameter1.pkl"))
